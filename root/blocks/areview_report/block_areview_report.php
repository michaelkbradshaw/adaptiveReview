<?php
class block_areview_report extends block_list 
{
	public function init() 
	{
		$this->title = get_string('areview_report', 'block_areview_report');
	}
	...
	public function get_content() {
		...
		include_once($CFG->dirroot.'/mod/areview/locallib.php');
		//FIXME areview should be part of private data...
		
		if(!empty($this->config->areview_id) )
		{
			$scores = areview_get_cummulative_scores($this->config->areview_id,$USER->id);
