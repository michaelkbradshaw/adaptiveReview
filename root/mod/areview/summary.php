...
/**
 * This page prints a summary of a areview attempt before it is submitted.
 *
 * @package    mod
 * @subpackage areview
...
$PAGE->set_url('/mod/areview/summary.php', array('attempt' => $attemptid));
...
// Log this page view.
add_to_log($attemptobj->get_courseid(), 'areview', 'view summary',
...
$navbc = $attemptobj->get_navigation_panel($output, 'areview_attempt_nav_panel', -1);
$regions = $PAGE->blocks->get_regions();
$PAGE->blocks->add_fake_block($navbc, reset($regions));

$PAGE->navbar->add(get_string('summaryofattempt', 'areview'));
