...
/**
 * Defines the form that limits student's access to attempt a areview.
 *
 * @package    mod
 * @subpackage areview
...
/**
 * A form that limits student's access to attempt a areview.
 *
 * @copyright  2011 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_areview_preflight_check_form extends moodleform {
