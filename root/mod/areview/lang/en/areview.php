...
/**
 * Strings for component 'areview', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package    mod
 * @subpackage areview
...
$string['accessnoticesheader'] = 'You can preview this areview, but if this were a real attempt, you would be blocked because:';
$string['action'] = 'Action';
$string['activityoverview'] = 'You have areviewzes that are due';
$string['adaptive'] = 'Adaptive mode';
$string['adaptive_help'] = 'If enabled, multiple responses to a question are allowed within the same attempt at the areview. So for example if a response is marked as incorrect, the student will be allowed to try again immediately. However, depending on the "Apply penalties" setting, a penalty will usually be subtracted for each wrong attempt.';
$string['addaquestion'] = 'Add a question ...';
$string['addarandomquestion'] = 'Add a random question ...';
$string['addarandomquestion_help'] = 'When a random question is added, it results in a randomly-chosen question from the category being inserted into the areview. This means that different students are likely to get a different selection of questions, and when a areview allows multiple attempts then each attempt is likely to contain a new selection of questions.';
$string['adddescriptionlabel'] = 'Add description/label';
$string['addingquestion'] = 'Adding a question';
$string['addingquestions'] = 'This side of the page is where you manage your database of questions.  Questions are stored in categories to help you keep them organised, and can be used by any areview in your course or even other courses if you choose to \'publish\' them. <br /><br />After you select or create a question category you will be able to create or edit questions.  You can select any of these questions to add to your areview over on the other side of this page.';
...
$string['addquestionstoareview'] = 'Add questions to current areview';
...
$string['addarandomquestion_help'] = 'When a random question is added, it results in a randomly-chosen question from the category being inserted into the areview. This means that different students are likely to get a different selection of questions, and when a areview allows multiple attempts then each attempt is likely to contain a new selection of questions.';
$string['addrandomquestiontoareview'] = 'Add a random question to areview {$a}';
$string['addrandom1'] = '<< Add';
$string['addrandom2'] = 'random questions';
$string['addselectedtoareview'] = 'Add selected to areview';
$string['addtoareview'] = 'Add to areview';
...
$string['attempterror'] = 'You are not allowed to attempt this areview at this time because: {$a}';
$string['attemptfirst'] = 'First attempt';
$string['attemptincomplete'] = 'That attempt (by {$a}) is not yet completed.';
$string['attemptlast'] = 'Last attempt';
$string['attemptnumber'] = 'Attempt';
$string['attemptareviewnow'] = 'Attempt areview now';
$string['attempts'] = 'Attempts';
$string['attemptsallowed'] = 'Attempts allowed';
$string['attemptsdeleted'] = 'areview attempts deleted';
...
$string['autosaveperiod_desc'] = 'Students\' responses can be saved automatically every few minutes during areview attempts. This involves a trade-off: saving the responses increases the server load, but reduces the chance that students lose their work.';
$string['back'] = 'Back to preview question';
$string['backtocourse'] = 'Back to the course';
$string['backtoquestionlist'] = 'Back to question list';
$string['backtoareview'] = 'Back to areview editing';
$string['basicideasofareview'] = 'The basic ideas of areview-making';
...
* The areview will only start if the student has a JavaScript-enabled web-browser
* The areview appears in a full screen popup window that covers all the other windows and has no navigation controls
...
$string['cannoteditafterattempts'] = 'You cannot add or remove questions because this areview has been attempted. ({$a})';
...
$string['cannotsetgrade'] = 'Could not set a new maximum grade for the areview';
$string['cannotsetsumgrades'] = 'Failed to set sumgrades';
$string['cannotstartgradesmismatch'] = 'Cannot start an attempt at this areview. The areview is set to be graded out of {$a->grade}, but none of the questions in the areview have a grade. This can be fixed on the \'Edit areview\' page.';
$string['cannotstartmissingquestion'] = 'Cannot start an attempt at this areview. The areview definition includes a question that does not exist.';
$string['cannotstartnoquestions'] = "You've been busy.  There are no more questions for you to answer right now.  Come back tomorrow and we'll get you some more questions";
...
$string['closebeforeopen'] = 'Could not update the areview. You have specified a close date before the open date.';
...
$string['configadaptive'] = 'If you choose Yes for this option then the student will be allowed multiple responses to a question even within the same attempt at the areview.';
$string['configattemptsallowed'] = 'Restriction on the number of attempts students are allowed at the areview.';
$string['configdecimaldigits'] = 'Number of digits that should be shown after the decimal point when displaying grades.';
$string['configdecimalplaces'] = 'Number of digits that should be shown after the decimal point when displaying grades for the areview.';
...
$string['configdelay1'] = 'If you set a time delay, then a student has to wait for that time before they can attempt a areview after the first attempt.';
...
$string['configgrademethod'] = 'When multiple attempts are allowed, which method should be used to calculate the student\'s final grade for the areview.';
$string['configintro'] = 'The values you set here define the default values that are used in the settings form when you create a new areview. You can also configure which areview settings are considered advanced.';
$string['configmaximumgrade'] = 'The default grade that the areview grade is scaled to be out of.';
$string['confignewpageevery'] = 'When adding questions to the areview page breaks will automatically be inserted according to the setting you choose here.';
...
$string['configoutcomesadvanced'] = 'If this option is turned on, then the Outcomes on the areview editing form are advanced settings.';
$string['configpenaltyscheme'] = 'Penalty subtracted for each wrong response in adaptive mode.';
$string['configpopup'] = 'Force the attempt to open in a popup window, and use JavaScript tricks to try to restrict copy and paste, etc. during areview attempts.';
$string['configrequirepassword'] = 'Students must enter this password before they can attempt the areview.';
$string['configrequiresubnet'] = 'Students can only attempt the areview from these computers.';
$string['configreviewoptions'] = 'These options control what information users can see when they review a areview attempt or look at the areview reports.';
$string['configshowblocks'] = 'Show blocks during areview attempts.';
$string['configshowuserpicture'] = 'Show the user\'s picture on screen during attempts.';
$string['configshufflequestions'] = 'If you enable this option, then the order of questions in  the areview will be randomly shuffled each time a student attempts the areview.';
$string['configshufflewithin'] = 'If you enable this option, then the parts making up the individual questions will be randomly shuffled each time a student starts an attempt at this areview, provided the option is also enabled in the question settings.';
$string['configtimelimit'] = 'Default time limit for areviewzes in minutes. 0 means no time limit.';
$string['configtimelimitsec'] = 'Default time limit for areviewzes in seconds. 0 mean no time limit.';
...
$string['confirmstartattempttimelimit'] = 'This areview has a time limit and is limited to {$a} attempt(s). You are about to start a new attempt.  Do you wish to proceed?';
$string['confirmstarttimelimit'] = 'The areview has a time limit. Are you sure that you wish to start?';
...
$string['continueattemptareview'] = 'Continue the last attempt';
...
$string['countdownfinished'] = 'The areview is closing, you should submit your answers now.';
$string['countdowntenminutes'] = 'The areview will be closing in ten minutes.';
...
$string['createmultiple'] = 'Add several random questions to areview';
$string['createnewquestion'] = 'Create new question';
$string['createquestionandadd'] = 'Create a new question and add it to the areview.';
...
$string['delaylater_help'] = 'If enabled, a student must wait for the specified time to elapse before attempting the areview a third time and any subsequent times.';
$string['delay1'] = 'Time delay between first and second attempt';
$string['delay1st2nd'] = 'Enforced delay between 1st and 2nd attempts';
$string['delay1st2nd_help'] = 'If enabled, a student must wait for the specified time to elapse before being able to attempt the areview a second time.';
...
$string['downloadextra'] = '(file is also stored in the course files in the /backupdata/areview folder)';
...
$string['eachattemptbuildsonthelast_help'] = 'If multiple attempts are allowed and this setting is enabled, each new areview attempt will contain the results of the previous attempt. This allows a areview to be completed over several attempts.';
$string['editcategories'] = 'Edit categories';
$string['editcategory'] = 'Edit category';
$string['editcatquestions'] = 'Edit category questions';
$string['editingquestion'] = 'Editing a question';
$string['editingareview'] = 'Editing areview';
$string['editingareview_help'] = 'When creating a areview, the main concepts are:

* The areview, containing questions over one or more pages
* The question bank, which stores copies of all questions organised into categories
* Random questions -  A student gets different questions each time they attempt the areview and different students can get different questions';
$string['editingareview_link'] = 'mod/areview/edit';
$string['editingareviewx'] = 'Editing areview: {$a}';
$string['editoverride'] = 'Edit override';
$string['editqcats'] = 'Edit questions categories';
$string['editquestions'] = 'Edit questions';
$string['editareview'] = 'Edit areview';
$string['editareviewquestions'] = 'Edit areview questions';
...
You can access this areview at {$a->areviewurl}.';
$string['emailconfirmsmall'] = 'Thank you for submitting your answers to \'{$a->areviewname}\'';
$string['emailconfirmsubject'] = 'Submission confirmation: {$a->areviewname}';
$string['emailnotifybody'] = 'Dear {$a->username},

{$a->studentname} has completed
\'{$a->areviewname}\' ({$a->areviewurl})
in course \'{$a->coursename}\'

You can review this attempt at {$a->areviewreviewurl}.';
$string['emailnotifysmall'] = '{$a->studentname} has completed {$a->areviewname}. See {$a->areviewreviewurl}';
$string['emailnotifysubject'] = '{$a->studentname} has completed {$a->areviewname}';
$string['emailoverduebody'] = 'Dear {$a->studentname},

You started an attempt at \'{$a->areviewname}\'
...
$string['emailoverduesmall'] = 'You did not submit your attempt at {$a->areviewname}. Please go to {$a->attemptsummaryurl} before {$a->attemptgraceend} if you would still like to submit.';
$string['emailoverduesubject'] = 'Attempt now overdue: {$a->areviewname}';
$string['empty'] = 'Empty';
...
$string['graceperiodmin_desc'] = 'There is a potential problem right at the end of the areview. On the one hand, we want to let students continue working right up until the last second - with the help of the timer that automatically submits the areview when time runs out. On the other hand, the server may then be overloaded, and take some time to get to process the responses. Therefore, we will accept responses for up to this many seconds after time expires, so they are not penalised for the server being slow. However, the student could cheat and get this many seconds to answer the areview. You have to make a trade-off based on how much you trust the performance of your server during areviewzes.';
...
$string['grademethod_help'] = 'When multiple attempts are allowed, the following methods are available for calculating the final areview grade:

* Highest grade of all attempts
* Average (mean) grade of all attempts
* First attempt (all other attempts are ignored)
* Last attempt (all other attempts are ignored)';
$string['gradesdeleted'] = 'areview grades deleted';
$string['gradesofar'] = '{$a->method}: {$a->mygrade} / {$a->areviewgrade}.';
...
$string['guestsno'] = 'Sorry, guests cannot see or attempt areviewzes';
$string['hidebreaks'] = 'Hide page breaks';
$string['hidereordertool'] = 'Hide the reordering tool';
$string['history'] = 'History of responses:';
$string['howquestionsbehave_desc'] = 'Default setting for how questions behave in a areview.';
...
$string['inactiveoverridehelp'] = '* Student does not have the correct group or role to attempt the areview';
...
$string['invalidareviewid'] = 'Invalid areview ID';
...
$string['link'] = 'Link';
$string['listitems'] = 'Listing of items in areview';
...
$string['messageprovider:attempt_overdue'] = 'Warning when your areview attempt becomes overdue';
$string['messageprovider:confirmation'] = 'Confirmation of your own areview submissions';
$string['messageprovider:submission'] = 'Notification of areview submissions';
$string['max'] = 'Max';
$string['min'] = 'Min';
...
$string['modulename'] = 'areview';
$string['modulename_help'] = 'The areview activity enables a teacher to create areviewzes comprising questions of various types, including multiple choice, matching, short-answer and numerical.

The teacher can allow the areview to be attempted multiple times, with the questions shuffled or randomly selected from the question bank. A time limit may be set.
...
* For self-assessment';
$string['modulename_link'] = 'mod/areview/view';
$string['modulenameplural'] = 'areviewzes';
...
$string['navmethod_help'] = 'When sequential navigation is enabled a student must progress through the areview in order and may not return to previous pages nor skip ahead.';
...
$string['newattemptfail'] = 'Error: Could not start a new attempt at the areview';
$string['newpage'] = 'New page';
$string['newpage_help'] = 'For longer areviewzes it makes sense to stretch the areview over several pages by limiting the number of questions per page. When adding questions to the areview, page breaks will automatically be inserted according to this setting. However page breaks may later be moved manually on the editing page.';
$string['newpageevery'] = 'Automatically start a new page';
$string['noanswers'] = 'No answers were selected!';
$string['noattempts'] = 'No attempts have been made on this areview';
...
$string['nogradewarning'] = 'This areview is not graded, so you cannot set overall feedback that differs by grade.';
$string['nomoreattempts'] = 'No more attempts are allowed';
$string['none'] = 'None';
$string['noopen'] = 'No open date';
$string['nooverridedata'] = 'You must override at least one of the areview settings.';
...
$string['noquestionsinareview'] = 'There are no questions in this areview.';
...
$string['noreview'] = 'You are not allowed to review this areview';
$string['noreviewattempt'] = 'You are not allowed to review this attempt.';
$string['noreviewshort'] = 'Not permitted';
$string['noreviewuntil'] = 'You are not allowed to review this areview until {$a}';
$string['noreviewuntilshort'] = 'Available {$a}';
$string['noscript'] = 'JavaScript must be enabled to continue!';
$string['notavailabletostudents'] = 'Note: This areview is not currently available to your students';
...
$string['notimedependentitems'] = 'Time dependent items are not currently supported by the areview module. As a work around, set a time limit for the whole areview. Do you wish to choose a different item (or use the current item regardless)?';
$string['notyetgraded'] = 'Not yet graded';
$string['notyetviewed'] = 'Not yet viewed';
$string['notyourattempt'] = 'This is not your attempt!';
$string['noview'] = 'Logged-in user is not allowed to view this areview';
$string['numattempts'] = '{$a->studentnum} {$a->studentstring} have made {$a->attemptnum} attempts';
$string['numattemptsmade'] = '{$a} attempts made on this areview';
$string['numberabbr'] = '#';
...
$string['openclosedatesupdated'] = 'areview open and close dates updated';
...
$string['orderingareview'] = 'Order and paging';
$string['orderingareviewx'] = 'Order and paging: {$a}';
...
$string['overallfeedback_help'] = 'Overall feedback is text that is shown after a areview has been attempted. By specifying additional grade boundaries (as a percentage or as a number), the text shown can depend on the grade obtained.';
$string['overdue'] = 'Overdue';
$string['overduehandling'] = 'When time expires';
$string['overduehandling_desc'] = 'What should happen by default if a student does not submit the areview before time expires.';
$string['overduehandling_help'] = 'This setting controls what happens if the Student fails to submit their areview attempt before time expires. If the student is actively working on the areview at the time, then the countdown timer will always automatically submit the attempt for them, but if they have logged out, then this setting controls what happens.';
$string['overduehandling_link'] = 'mod/areview/timing';
...
$string['overduemustbesubmittedby'] = 'This attempt is now overdue. It should already have been submitted. If you would like this areview to be graded, you must submit it by {$a}. If you do not submit it by then, no marks from this attempt will be counted.';
...
$string['overridegroupeventname'] = '{$a->areview} - {$a->group}';
$string['overrides'] = 'Overrides';
$string['overrideuser'] = 'Override user';
$string['overrideusereventname'] = '{$a->areview} - Override';
$string['page-mod-areview-x'] = 'Any areview module page';
$string['page-mod-areview-edit'] = 'Edit areview page';
...
$string['pluginadministration'] = 'areview administration';
$string['pluginname'] = 'areview';
$string['popup'] = 'Show areview in a &quot;secure&quot; window';
$string['popupblockerwarning'] = 'This section of the test is in secure mode, this means that you need to take the areview in a secure window. Please turn off your popup blocker. Thank you.';
$string['popupnotice'] = 'Students will see this areview in a secure window';
$string['preprocesserror'] = 'Error occurred during pre-processing!';
$string['preview'] = 'Preview';
$string['previewquestion'] = 'Preview question';
$string['previewareview'] = 'Preview {$a}';
$string['previewareviewnow'] = 'Preview areview now';
...
$string['questioninuse'] = 'The question \'{$a->questionname}\' is currently being used in: <br />{$a->areviewnames}<br />The question will not be deleted from these areviewzes but only from the category list.';
...
$string['questionsinthisareview'] = 'Questions in this areview';
...
$string['areview:addinstance'] = 'Add a new areview';
$string['areview:attempt'] = 'Attempt areviewzes';
$string['areviewavailable'] = 'The areview is available until: {$a}';
$string['areviewclose'] = 'Close the areview';
$string['areviewclosed'] = 'This areview closed on {$a}';
$string['areviewcloses'] = 'areview closes';
$string['areviewcloseson'] = 'This areview will close at {$a}';
$string['areview:deleteattempts'] = 'Delete areview attempts';
$string['areview:emailconfirmsubmission'] = 'Get a confirmation message when submitting';
$string['areview:emailnotifysubmission'] = 'Get a notification message when an attempt is submitted';
$string['areview:emailwarnoverdue'] = 'Get a notification message when an attempt becomes overdue and needs to be submitted.';
$string['areview:grade'] = 'Grade areviewzes manually';
$string['areview:ignoretimelimits'] = 'Ignores time limit on areviewzes';
$string['areviewisclosed'] = 'This areview is closed';
$string['areviewisopen'] = 'This areview is open';
$string['areviewisclosedwillopen'] = 'areview closed (opens {$a})';
$string['areviewisopenwillclose'] = 'areview open (closes {$a})';
$string['areview:manage'] = 'Manage areviewzes';
$string['areview:manageoverrides'] = 'Manage areview overrides';
$string['areviewnavigation'] = 'areview navigation';
$string['areviewopen'] = 'Open the areview';
$string['areviewopenclose'] = 'Open and close dates';
$string['areviewopenclose_help'] = 'Students can only start their attempt(s) after the open time and they must complete their attempts before the close time.';
$string['areviewopenclose_link'] = 'mod/areview/timing';
$string['areviewopened'] = 'This areview is open.';
$string['areviewopenedon'] = 'This areview opened at {$a}';
$string['areviewopens'] = 'areview opens';
$string['areviewopenwillclose'] = 'This areview is open, will close on {$a} at';
$string['areviewordernotrandom'] = 'Order of areview not shuffled';
$string['arevieworderrandom'] = '* Order of areview is shuffled';
$string['areview:preview'] = 'Preview areviewzes';
$string['areview:regrade'] = 'Regrade areview attempts';
$string['areview:reviewmyattempts'] = 'Review your own attempts';
$string['areviewsettings'] = 'areview settings';
$string['areview:view'] = 'View areview information';
$string['areview:viewreports'] = 'View areview reports';
$string['areviewtimer'] = 'areview Timer';
$string['areviewwillopen'] = 'This areview will open {$a}';
...
$string['readytosend'] = 'You are about to send your whole areview to be graded.  Are you sure you want to continue?';
$string['reattemptareview'] = 'Do Next Review';
...
$string['regradenotallowed'] = 'You do not have permission to regrade this areview';
$string['regradingquestion'] = 'Regrading "{$a}".';
$string['regradingareview'] = 'Regrading areview "{$a}"';
$string['remove'] = 'Remove';
$string['removeallareviewattempts'] = 'Delete all areview attempts';
...
$string['reportusersall'] = 'all users who have attempted the areview';
$string['reportuserswith'] = 'enrolled users who have attempted the areview';
$string['reportuserswithorwithout'] = 'enrolled users who have, or have not, attempted the areview';
$string['reportuserswithout'] = 'enrolled users who have not attempted the areview';
$string['reportwhattoinclude'] = 'What to include in the report';
$string['requirepassword'] = 'Require password';
$string['requirepassword_help'] = 'If a password is specified, a student must enter it in order to attempt the areview.';
$string['requiresubnet'] = 'Require network address';
$string['requiresubnet_help'] = 'areview access may be restricted to particular subnets on the LAN or Internet by specifying a comma-separated list of partial or full IP address numbers. This can be useful for an invigilated (proctored) areview, to ensure that only people in a certain location can access the areview.';
$string['response'] = 'Response';
$string['responses'] = 'Responses';
$string['results'] = 'Results';
$string['returnattempt'] = 'Return to attempt';
$string['reuseifpossible'] = 'reuse previously removed';
$string['reverttodefaults'] = 'Revert to areview defaults';
$string['review'] = 'Review';
$string['reviewafter'] = 'Allow review after areview is closed';
$string['reviewalways'] = 'Allow review at any time';
$string['reviewattempt'] = 'Review attempt';
$string['reviewbefore'] = 'Allow review while areview is open';
$string['reviewclosed'] = 'After the areview is closed';
...
$string['reviewopen'] = 'Later, while the areview is still open';
$string['reviewoptions'] = 'Students may review';
$string['reviewoptionsheading'] = 'Review options';
$string['reviewoptionsheading_help'] = 'These options control what information students can see when they review a areview attempt or look at the areview reports.
...
**Later, while the areview is still open** settings apply after this, and before the areview close date.

**After the areview is closed** settings apply after the areview close date has passed. If the areview does not have a close date, this state is never reached.';
...
$string['saveattemptfailed'] = 'Failed to save the current areview attempt.';
...
$string['saveareview'] = 'Save this whole areview';
...
$string['showblocks'] = 'Show blocks during areview attempts';
$string['showblocks_help'] = 'If set to yes then normal blocks will be shown during areview attempts';
...
$string['shufflewithin_help'] = 'If enabled, the parts making up each question will be randomly shuffled each time a student attempts the areview, provided the option is also enabled in the question settings. This setting only applies to questions that have multiple parts, such as multiple choice or matching questions.';
...
$string['specificquestionnotonareview'] = 'Specified question is not on the specified areview';
...
$string['subneterror'] = 'Sorry, this areview has been locked so that it is only accessible from certain locations.  Currently your computer is not one of those allowed to use this areview.';
$string['subnetnotice'] = 'This areview has been locked so that it is only accessible from certain locations. Your computer is not on an allowed subnet. As teacher you are allowed to preview anyway.';
$string['subplugintype_areview'] = 'Report';
$string['subplugintype_areview_plural'] = 'Reports';
$string['subplugintype_areviewaccess'] = 'Access rule';
$string['subplugintype_areviewaccess_plural'] = 'Access rules';
...
$string['temporaryblocked'] = 'You are temporarily not allowed to re-attempt the areview.<br /> You will be able to take another attempt on:';
$string['theattempt'] = 'The attempt';
$string['theattempt_help'] = 'Whether the student can review the attempt at all.';
$string['time'] = 'Time';
$string['timecompleted'] = 'Completed';
$string['timedelay'] = 'You are not allowed to do the areview since you have not passed the time delay before attempting another areview';
$string['timeleft'] = 'Time left';
$string['timelimit'] = 'Time limit';
$string['timelimit_help'] = 'If enabled, the time limit is stated on the initial areview page and a countdown timer is displayed in the areview navigation block.';
$string['timelimit_link'] = 'mod/areview/timing';
$string['timelimitexeeded'] = 'Sorry! areview time limit exceeded!';
...
$string['updatesettings'] = 'Update areview settings';
...
$string['upgradesure'] = '<div>In particular the areview module will perform an extensive change of the areview tables and this upgrade has not yet been sufficiently tested. You are very strongly urged to backup your database tables before proceeding.</div>';
$string['upgradingareviewattempts'] = 'Upgrading areview attempts: areview {$a->done}/{$a->outof} (areview id {$a->info})';
$string['upgradingveryoldareviewattempts'] = 'Upgrading very old areview attempts: {$a->done}/{$a->outof}';
$string['url'] = 'URL';
...
$string['usersnone'] = 'No students have access to this areview';
$string['validate'] = 'Validate';
$string['viewallanswers'] = 'View {$a} areview attempts';
...
$string['xhtml'] = 'XHTML';
$string['youneedtoenrol'] = 'You need to enrol in this course before you can attempt this areview';
$string['yourfinalgradeis'] = 'Your final grade for this areview is {$a}.';
