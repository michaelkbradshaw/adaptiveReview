...
/**
 * Admin settings class for the areview review opitions.
 *
 * @copyright  2008 Tim Hunt
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_areview_admin_review_setting extends admin_setting {
    /**#@+
     * @var integer should match the constants defined in {@link mod_areview_display_options}.
    ...
    /**
     * This should match {@link mod_areview_mod_form::$reviewfields} but copied
     * here because generating the admin tree needs to be fast.
     * @return array
     */
    public static function fields() {
        return array(
            'attempt' => get_string('theattempt', 'areview'),
            ...
            'overallfeedback' => get_string('overallfeedback', 'areview'),
        );
    }
    ...
    protected static function times() {
        return array(
            self::DURING => get_string('reviewduring', 'areview'),
            self::IMMEDIATELY_AFTER => get_string('reviewimmediately', 'areview'),
            self::LATER_WHILE_OPEN => get_string('reviewopen', 'areview'),
            self::AFTER_CLOSE => get_string('reviewclosed', 'areview'),
        );
    }
    ...
    public function output_html($data, $query = '') {
        ...
        return format_admin_setting($this, $this->visiblename, $return,
                $this->description, true, '', get_string('everythingon', 'areview'), $query);
    }
}


/**
 * Admin settings class for the areview grading method.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_areview_admin_setting_grademethod extends admin_setting_configselect_with_advanced {
    public function load_choices() {
        ...
        $this->choices = areview_get_grading_options();
...
/**
 * Admin settings class for the areview browser security option.
 *
 * Just so we can lazy-load the choices.
 *
 * @copyright  2011 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_areview_admin_setting_browsersecurity extends admin_setting_configselect_with_advanced {
    public function load_choices() {
        global $CFG;
        ...
        require_once($CFG->dirroot . '/mod/areview/locallib.php');
        $this->choices = areview_access_manager::get_browser_security_choices();
...
/**
 * Admin settings class for the areview overdue attempt handling method.
 *
 * Just so we can lazy-load the choices.
 *
 * @copyright  2011 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_areview_admin_setting_overduehandling extends admin_setting_configselect_with_advanced {
    public function load_choices() {
        global $CFG;
        ...
        require_once($CFG->dirroot . '/mod/areview/locallib.php');
        $this->choices = areview_get_overdue_handling_options();
