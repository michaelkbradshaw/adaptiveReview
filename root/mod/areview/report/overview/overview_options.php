...
/**
 * Class to store the options for a {@link areview_overview_report}.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class areview_overview_options extends mod_areview_attempts_report_options {
    ...
    public function setup_from_user_preferences() {
        ...
        $this->slotmarks = get_user_preferences('areview_report_overview_detailedmarks', $this->slotmarks);
    }

    public function update_user_preferences() {
        parent::update_user_preferences();

        if (areview_has_grades($this->areview)) {
            set_user_preference('areview_overview_slotmarks', $this->slotmarks);
        }
    }
    ...
    public function resolve_dependencies() {
        ...
        $this->checkboxcolumn = has_any_capability(
                array('mod/areview:regrade', 'mod/areview:deleteattempts'), context_module::instance($this->cm->id))
