...
/**
 * Strings for component 'areview_overview', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['nogradepermission'] = 'You don\'t have permission to grade this areview.';
$string['onlyoneattemptallowed'] = 'Only one attempt per user allowed on this areview.';
$string['optallattempts'] = 'all attempts';
$string['optallstudents'] = 'all {$a} who have or have not attempted the areview';
$string['optattemptsonly'] = '{$a} who have attempted the areview';
$string['optnoattemptsonly'] = '{$a} who have not attempted the areview';
...
$string['showinggradedandungraded'] = 'Showing graded and ungraded attempts for each user. The one attempt for each user that is graded is highlighted. The grading method for this areview is {$a}.';
