...
/**
 * Strings for component 'areview_statistics', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['backtoareviewreport'] = 'Back to main statistics report page.';
...
$string['errorpowers'] = 'Error fetching data to calculate variance for areview grades';
...
$string['negcovar_help'] = 'This question\'s grade for this set of attempts on the areview varies in an opposite way to the overall attempt grade. This means overall attempt grade tends to be below average when the grade for this question is above average and vice-versa.

Our equation for effective question weight cannot be calculated in this case. The calculations for effective question weight for other questions in this areview are the effective question weight for these questions if the highlighted questions with a negative covariance are given a maximum grade of zero.

If you edit a areview and give these question(s) with negative covariance a max grade of zero then the effective question weight of these questions will be zero and the real effective question weight of other questions will be as calculated now.';
...
$string['areviewinformation'] = 'Quiz information';
$string['areviewname'] = 'Quiz name';
$string['areviewoverallstatistics'] = 'Quiz overall statistics';
$string['areviewstructureanalysis'] = 'Quiz structure analysis';
