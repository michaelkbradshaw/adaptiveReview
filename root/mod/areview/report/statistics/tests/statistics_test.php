...
/**
 * Unit tests for (some of) mod/areview/report/statistics/qstats.php.
 *
...
/**
 * Test helper subclass of areview_statistics_question_stats
 *
 * @copyright 2010 The Open University
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class testable_areview_statistics_question_stats extends areview_statistics_question_stats {
...
/**
 * Unit tests for (some of) areview_statistics_question_stats.
 *
 * @copyright 2008 Jamie Pratt
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class areview_statistics_question_stats_testcase extends basic_testcase {
    ...
    public function test_qstats() {
        ...
        $this->qstats = new testable_areview_statistics_question_stats($questions, 22, 10045.45455);
        $this->qstats->set_step_data($steps);
        $this->qstats->compute_statistics();

        // Values expected are taken from contrib/tools/areview_tools/stats.xls.
