...
/**
 * Standard plugin entry points of the areview statistics report.
 *
 ...
 */
function areview_statistics_questiontext_preview_pluginfile($context, $questionid, $args, $forcedownload, array $options=array()) {
    global $CFG;
    ...
    require_capability('areview/statistics:view', $context);
 ...
 */
function areview_statistics_cron() {
    global $DB;

    $expiretime = time() - 5*HOURSECS;
    $todelete = $DB->get_records_select_menu('areview_statistics',
