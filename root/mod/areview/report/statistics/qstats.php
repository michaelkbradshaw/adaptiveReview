 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class areview_statistics_question_stats {
    public $questions;
     ...
     */
    public function load_step_data($areviewid, $currentgroup, $groupstudents, $allattempts) {
        global $DB;
        ...
        list($fromqa, $whereqa, $qaparams) = areview_statistics_attempts_sql(
                $areviewid, $currentgroup, $groupstudents, $allattempts, false);
        ...
        $this->lateststeps = $DB->get_records_sql("
                ...
                FROM $fromqa
                JOIN {question_attempts} qa ON qa.questionusageid = areviewa.uniqueid
                JOIN (
        ...
        foreach ($this->subquestions as $qid => $subquestion) {
            ...
            if ($subquestionstats[$qid]->differentweights) {
                ...
                echo $OUTPUT->notification(
                        ...
                        'areview_statistics', $this->subquestions[$qid]->name));
            }
