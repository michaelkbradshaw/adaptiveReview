...
/**
 * This file defines the areview responses table.
 *
...
/**
 * This is a table subclass for displaying the areview responses report.
 *
 * @copyright 2008 Jean-Michel Vedrine
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class areview_responses_table extends areview_attempts_report_table {
     ...
     * @param areview_responses_options $options
     * @param array $groupstudents
     * @param array $students
     * @param array $questions
     * @param moodle_url $reporturl
     */
    public function __construct($areview, $context, $qmsubselect, areview_responses_options $options,
            $groupstudents, $students, $questions, $reporturl) {
        parent::__construct('mod-areview-report-responses-report', $areview, $context,
    ...
    public function col_sumgrades($attempt) {
        ...
        $gradehtml = '<a href="review.php?q=' . $this->areview->id . '&amp;attempt=' .
