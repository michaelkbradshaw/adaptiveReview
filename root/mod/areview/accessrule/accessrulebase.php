...
/**
 * Base class for rules that restrict the ability to attempt a areview.
 *
 * @package    mod
 * @subpackage areview
...
/**
 * A base class that defines the interface for the various areview access rules.
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class areview_access_rule_base {
    /** @var stdClass the areview settings. */
    protected $areview;
    /** @var areview the areview object. */
    protected $areviewobj;
    /** @var int the time to use as 'now'. */
    protected $timenow;

    /**
     * Create an instance of this rule for a particular areview.
     * @param areview $areviewobj information about the areview in question.
     * @param int $timenow the time that should be considered as 'now'.
     */
    public function __construct($areviewobj, $timenow) {
        $this->areviewobj = $areviewobj;
        $this->areview = $areviewobj->get_areview();
        $this->timenow = $timenow;
    }

    /**
     * Return an appropriately configured instance of this rule, if it is applicable
     * to the given areview, otherwise return null.
     * @param areview $areviewobj information about the areview in question.
     * @param int $timenow the time that should be considered as 'now'.
     * @param bool $canignoretimelimits whether the current user is exempt from
     *      time limits by the mod/areview:ignoretimelimits capability.
     * @return areview_access_rule_base|null the rule, if applicable, else null.
     */
     ...
     *
     * @param mod_areview_preflight_check_form $areviewform the form being built.
    ...
    /**
     * This is called when the current attempt at the areview is finished. This is
    ...
    /**
     * Information, such as might be shown on the areview view page, relating to this restriction.
     ...
     * this areview, then return true. This is used so we can know whether to display a
    ...
    /**
     * Add any fields that this rule requires to the areview settings form. This
     * method is called from {@link mod_areview_mod_form::definition()}, while the
    ...
    public static function validate_settings_form_fields(array $errors,
            array $data, $files, mod_areview_mod_form $areviewform) {

        return $errors;
    }

    /**
     * @return array key => lang string any choices to add to the areview Browser
    ...
    /**
     * Save any submitted settings when the areview settings form is submitted. This
     * is called from {@link areview_after_add_or_update()} in lib.php.
     ...
     * here is probalby to read the code of {@link areview_access_manager::load_settings()}.
     *
     * If you have some settings that cannot be loaded in this way, then you can
     * use the {@link get_extra_settings()} method instead, but that has
     * performance implications.
     *
     * @param int $areviewid the id of the areview we are loading settings for. This
     *     can also be accessed as areview.id in the SQL. (areview is a table alisas for {areview}.)
     ...
     */
    public static function get_settings_sql($areviewid) {
        return array('', '', array());
    }
     ...
     */
    public static function get_extra_settings($areviewid) {
        return array();
    }
}
