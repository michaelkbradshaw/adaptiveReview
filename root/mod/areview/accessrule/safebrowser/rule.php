...
/**
 * Implementaton of the areviewaccess_safebrowser plugin.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class areviewaccess_safebrowser extends areview_access_rule_base {

    public static function make(areview $areviewobj, $timenow, $canignoretimelimits) {

        if ($areviewobj->get_areview()->browsersecurity !== 'safebrowser') {
            return null;
        }
    ...
    public function prevent_access() {
        if (!$this->check_safe_browser()) {
            return get_string('safebrowsererror', 'areviewaccess_safebrowser');
        } else {
            return false;
        }
    }
    ...
    public function description() {
        return get_string('safebrowsernotice', 'areviewaccess_safebrowser');
    }
    ...
    public static function get_browser_security_choices() {
        ...
        return array('safebrowser' =>
                get_string('requiresafeexambrowser', 'areviewaccess_safebrowser'));
    }
}
