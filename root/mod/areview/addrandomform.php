...
/**
 * Defines the Moodle forum used to add random questions to the areview.
 *
 * @package    mod
 * @subpackage areview
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class areview_add_random_form extends moodleform {
    ...
    protected function definition() {
        ...
        $mform->addElement('header', 'categoryheader',
                get_string('randomfromexistingcategory', 'areview'));

        $mform->addElement('questioncategory', 'category', get_string('category'),
                array('contexts' => $usablecontexts, 'top' => false));

        $mform->addElement('checkbox', 'includesubcategories', '', get_string('recurse', 'areview'));

        $mform->addElement('submit', 'existingcategory', get_string('addrandomquestion', 'areview'));

        // Random from a new category section.
        $mform->addElement('header', 'categoryheader',
                get_string('randomquestionusinganewcategory', 'areview'));
        ...
        $mform->addElement('submit', 'newcategory',
                get_string('createcategoryandaddrandomquestion', 'areview'));
