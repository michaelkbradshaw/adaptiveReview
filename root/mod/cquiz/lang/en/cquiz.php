...
$string['accessnoticesheader'] = 'You can preview this cquiz, but if this were a real attempt, you would be blocked because:';
$string['action'] = 'Action';
$string['activityoverview'] = 'You have cquizzes that are due';
$string['adaptive'] = 'Adaptive mode';
$string['adaptive_help'] = 'If enabled, multiple responses to a question are allowed within the same attempt at the cquiz. So for example if a response is marked as incorrect, the student will be allowed to try again immediately. However, depending on the "Apply penalties" setting, a penalty will usually be subtracted for each wrong attempt.';
$string['addaquestion'] = 'Add a question ...';
$string['addarandomquestion'] = 'Add a random question ...';
$string['addarandomquestion_help'] = 'When a random question is added, it results in a randomly-chosen question from the category being inserted into the cquiz. This means that different students are likely to get a different selection of questions, and when a cquiz allows multiple attempts then each attempt is likely to contain a new selection of questions.';
$string['adddescriptionlabel'] = 'Add description/label';
$string['addingquestion'] = 'Adding a question';
$string['addingquestions'] = 'This side of the page is where you manage your database of questions.  Questions are stored in categories to help you keep them organised, and can be used by any cquiz in your course or even other courses if you choose to \'publish\' them. <br /><br />After you select or create a question category you will be able to create or edit questions.  You can select any of these questions to add to your cquiz over on the other side of this page.';
...
$string['addquestionstocquiz'] = 'Add questions to current cquiz';
...
$string['addarandomquestion_help'] = 'When a random question is added, it results in a randomly-chosen question from the category being inserted into the cquiz. This means that different students are likely to get a different selection of questions, and when a cquiz allows multiple attempts then each attempt is likely to contain a new selection of questions.';
$string['addrandomquestiontocquiz'] = 'Add a random question to cquiz {$a}';
$string['addrandom1'] = '<< Add';
$string['addrandom2'] = 'random questions';
$string['addselectedtocquiz'] = 'Add selected to cquiz';
$string['addtocquiz'] = 'Add to cquiz';
...
$string['attempterror'] = 'You are not allowed to attempt this cquiz at this time because: {$a}';
$string['attemptfirst'] = 'First attempt';
$string['attemptincomplete'] = 'That attempt (by {$a}) is not yet completed.';
$string['attemptlast'] = 'Last attempt';
$string['attemptnumber'] = 'Attempt';
$string['attemptcquiznow'] = 'Attempt cquiz now';
$string['attempts'] = 'Attempts';
$string['attemptsallowed'] = 'Attempts allowed';
$string['attemptsdeleted'] = 'cQuiz attempts deleted';
...
$string['autosaveperiod_desc'] = 'Students\' responses can be saved automatically every few minutes during cquiz attempts. This involves a trade-off: saving the responses increases the server load, but reduces the chance that students lose their work.';
$string['back'] = 'Back to preview question';
$string['backtocourse'] = 'Back to the course';
$string['backtoquestionlist'] = 'Back to question list';
$string['backtocquiz'] = 'Back to cquiz editing';
$string['basicideasofcquiz'] = 'The basic ideas of cquiz-making';
...
* The cquiz will only start if the student has a JavaScript-enabled web-browser
* The cquiz appears in a full screen popup window that covers all the other windows and has no navigation controls
...
$string['cannoteditafterattempts'] = 'You cannot add or remove questions because this cquiz has been attempted. ({$a})';
...
$string['cannotsetgrade'] = 'Could not set a new maximum grade for the cquiz';
$string['cannotsetsumgrades'] = 'Failed to set sumgrades';
$string['cannotstartgradesmismatch'] = 'Cannot start an attempt at this cquiz. The cquiz is set to be graded out of {$a->grade}, but none of the questions in the cquiz have a grade. This can be fixed on the \'Edit cquiz\' page.';
$string['cannotstartmissingquestion'] = 'Cannot start an attempt at this cquiz. The cquiz definition includes a question that does not exist.';
...
$string['closebeforeopen'] = 'Could not update the cquiz. You have specified a close date before the open date.';
...
$string['configadaptive'] = 'If you choose Yes for this option then the student will be allowed multiple responses to a question even within the same attempt at the cquiz.';
$string['configattemptsallowed'] = 'Restriction on the number of attempts students are allowed at the cquiz.';
$string['configdecimaldigits'] = 'Number of digits that should be shown after the decimal point when displaying grades.';
$string['configdecimalplaces'] = 'Number of digits that should be shown after the decimal point when displaying grades for the cquiz.';
...
$string['configdelay1'] = 'If you set a time delay, then a student has to wait for that time before they can attempt a cquiz after the first attempt.';
...
$string['configgrademethod'] = 'When multiple attempts are allowed, which method should be used to calculate the student\'s final grade for the cquiz.';
$string['configintro'] = 'The values you set here define the default values that are used in the settings form when you create a new cquiz. You can also configure which cquiz settings are considered advanced.';
$string['configmaximumgrade'] = 'The default grade that the cquiz grade is scaled to be out of.';
$string['confignewpageevery'] = 'When adding questions to the cquiz page breaks will automatically be inserted according to the setting you choose here.';
...
$string['configoutcomesadvanced'] = 'If this option is turned on, then the Outcomes on the cquiz editing form are advanced settings.';
$string['configpenaltyscheme'] = 'Penalty subtracted for each wrong response in adaptive mode.';
$string['configpopup'] = 'Force the attempt to open in a popup window, and use JavaScript tricks to try to restrict copy and paste, etc. during cquiz attempts.';
$string['configrequirepassword'] = 'Students must enter this password before they can attempt the cquiz.';
$string['configrequiresubnet'] = 'Students can only attempt the cquiz from these computers.';
$string['configreviewoptions'] = 'These options control what information users can see when they review a cquiz attempt or look at the cquiz reports.';
$string['configshowblocks'] = 'Show blocks during cquiz attempts.';
$string['configshowuserpicture'] = 'Show the user\'s picture on screen during attempts.';
$string['configshufflequestions'] = 'If you enable this option, then the order of questions in  the cquiz will be randomly shuffled each time a student attempts the cquiz.';
$string['configshufflewithin'] = 'If you enable this option, then the parts making up the individual questions will be randomly shuffled each time a student starts an attempt at this cquiz, provided the option is also enabled in the question settings.';
$string['configtimelimit'] = 'Default time limit for cquizzes in minutes. 0 means no time limit.';
$string['configtimelimitsec'] = 'Default time limit for cquizzes in seconds. 0 mean no time limit.';
...
$string['confirmstartattempttimelimit'] = 'This cquiz has a time limit and is limited to {$a} attempt(s). You are about to start a new attempt.  Do you wish to proceed?';
$string['confirmstarttimelimit'] = 'The cquiz has a time limit. Are you sure that you wish to start?';
...
$string['countdownfinished'] = 'The cquiz is closing, you should submit your answers now.';
$string['countdowntenminutes'] = 'The cquiz will be closing in ten minutes.';
...
$string['createmultiple'] = 'Add several random questions to cquiz';
$string['createnewquestion'] = 'Create new question';
$string['createquestionandadd'] = 'Create a new question and add it to the cquiz.';
...
$string['delaylater_help'] = 'If enabled, a student must wait for the specified time to elapse before attempting the cquiz a third time and any subsequent times.';
$string['delay1'] = 'Time delay between first and second attempt';
$string['delay1st2nd'] = 'Enforced delay between 1st and 2nd attempts';
$string['delay1st2nd_help'] = 'If enabled, a student must wait for the specified time to elapse before being able to attempt the cquiz a second time.';
...
$string['eachattemptbuildsonthelast_help'] = 'If multiple attempts are allowed and this setting is enabled, each new cquiz attempt will contain the results of the previous attempt. This allows a cquiz to be completed over several attempts.';
$string['editcategories'] = 'Edit categories';
$string['editcategory'] = 'Edit category';
$string['editcatquestions'] = 'Edit category questions';
$string['editingquestion'] = 'Editing a question';
$string['editingcquiz'] = 'Editing cquiz';
$string['editingcquiz_help'] = 'When creating a cquiz, the main concepts are:

* The cquiz, containing questions over one or more pages
* The question bank, which stores copies of all questions organised into categories
* Random questions -  A student gets different questions each time they attempt the cquiz and different students can get different questions';
$string['editingcquiz_link'] = 'mod/cquiz/edit';
$string['editingcquizx'] = 'Editing cquiz: {$a}';
$string['editoverride'] = 'Edit override';
$string['editqcats'] = 'Edit questions categories';
$string['editquestions'] = 'Edit questions';
$string['editcquiz'] = 'Edit cquiz';
$string['editcquizquestions'] = 'Edit cquiz questions';
...
You can access this cquiz at {$a->cquizurl}.';
...
You can review this attempt at {$a->cquizreviewurl}.';
...
$string['graceperiodmin_desc'] = 'There is a potential problem right at the end of the cquiz. On the one hand, we want to let students continue working right up until the last second - with the help of the timer that automatically submits the cquiz when time runs out. On the other hand, the server may then be overloaded, and take some time to get to process the responses. Therefore, we will accept responses for up to this many seconds after time expires, so they are not penalised for the server being slow. However, the student could cheat and get this many seconds to answer the cquiz. You have to make a trade-off based on how much you trust the performance of your server during cquizzes.';
...
$string['grademethod_help'] = 'When multiple attempts are allowed, the following methods are available for calculating the final cquiz grade:

* Highest grade of all attempts
* Average (mean) grade of all attempts
* First attempt (all other attempts are ignored)
* Last attempt (all other attempts are ignored)';
$string['gradesdeleted'] = 'cQuiz grades deleted';
...
$string['guestsno'] = 'Sorry, guests cannot see or attempt cquizzes';
$string['hidebreaks'] = 'Hide page breaks';
$string['hidereordertool'] = 'Hide the reordering tool';
$string['history'] = 'History of responses:';
$string['howquestionsbehave_desc'] = 'Default setting for how questions behave in a cquiz.';
...
$string['inactiveoverridehelp'] = '* Student does not have the correct group or role to attempt the cquiz';
...
$string['invalidcquizid'] = 'Invalid cquiz ID';
...
$string['link'] = 'Link';
$string['listitems'] = 'Listing of items in cquiz';
...
$string['messageprovider:attempt_overdue'] = 'Warning when your cquiz attempt becomes overdue';
$string['messageprovider:confirmation'] = 'Confirmation of your own cquiz submissions';
$string['messageprovider:submission'] = 'Notification of cquiz submissions';
$string['max'] = 'Max';
$string['min'] = 'Min';
...
$string['modulename_help'] = 'The cquiz activity enables a teacher to create cquizzes comprising questions of various types, including multiple choice, matching, short-answer and numerical.

The teacher can allow the cquiz to be attempted multiple times, with the questions shuffled or randomly selected from the question bank. A time limit may be set.
...
$string['modulenameplural'] = 'cQuizzes';
...
$string['navmethod_help'] = 'When sequential navigation is enabled a student must progress through the cquiz in order and may not return to previous pages nor skip ahead.';
...
$string['newattemptfail'] = 'Error: Could not start a new attempt at the cquiz';
$string['newpage'] = 'New page';
$string['newpage_help'] = 'For longer cquizzes it makes sense to stretch the cquiz over several pages by limiting the number of questions per page. When adding questions to the cquiz, page breaks will automatically be inserted according to this setting. However page breaks may later be moved manually on the editing page.';
$string['newpageevery'] = 'Automatically start a new page';
$string['noanswers'] = 'No answers were selected!';
$string['noattempts'] = 'No attempts have been made on this cquiz';
...
$string['nogradewarning'] = 'This cquiz is not graded, so you cannot set overall feedback that differs by grade.';
$string['nomoreattempts'] = 'No more attempts are allowed';
$string['none'] = 'None';
$string['noopen'] = 'No open date';
$string['nooverridedata'] = 'You must override at least one of the cquiz settings.';
...
$string['noquestionsincquiz'] = 'There are no questions in this cquiz.';
...
$string['noreview'] = 'You are not allowed to review this cquiz';
$string['noreviewattempt'] = 'You are not allowed to review this attempt.';
$string['noreviewshort'] = 'Not permitted';
$string['noreviewuntil'] = 'You are not allowed to review this cquiz until {$a}';
$string['noreviewuntilshort'] = 'Available {$a}';
$string['noscript'] = 'JavaScript must be enabled to continue!';
$string['notavailabletostudents'] = 'Note: This cquiz is not currently available to your students';
...
$string['notimedependentitems'] = 'Time dependent items are not currently supported by the cquiz module. As a work around, set a time limit for the whole cquiz. Do you wish to choose a different item (or use the current item regardless)?';
$string['notyetgraded'] = 'Not yet graded';
$string['notyetviewed'] = 'Not yet viewed';
$string['notyourattempt'] = 'This is not your attempt!';
$string['noview'] = 'Logged-in user is not allowed to view this cquiz';
$string['numattempts'] = '{$a->studentnum} {$a->studentstring} have made {$a->attemptnum} attempts';
$string['numattemptsmade'] = '{$a} attempts made on this cquiz';
$string['numberabbr'] = '#';
...
$string['overallfeedback_help'] = 'Overall feedback is text that is shown after a cquiz has been attempted. By specifying additional grade boundaries (as a percentage or as a number), the text shown can depend on the grade obtained.';
$string['overdue'] = 'Overdue';
$string['overduehandling'] = 'When time expires';
$string['overduehandling_desc'] = 'What should happen by default if a student does not submit the cquiz before time expires.';
$string['overduehandling_help'] = 'This setting controls what happens if the Student fails to submit their cquiz attempt before time expires. If the student is actively working on the cquiz at the time, then the countdown timer will always automatically submit the attempt for them, but if they have logged out, then this setting controls what happens.';
...
$string['overduemustbesubmittedby'] = 'This attempt is now overdue. It should already have been submitted. If you would like this cquiz to be graded, you must submit it by {$a}. If you do not submit it by then, no marks from this attempt will be counted.';
...
$string['page-mod-cquiz-x'] = 'Any cquiz module page';
$string['page-mod-cquiz-edit'] = 'Edit cquiz page';
...
$string['pluginadministration'] = 'cQuiz administration';
$string['pluginname'] = 'cQuiz';
$string['popup'] = 'Show cquiz in a &quot;secure&quot; window';
$string['popupblockerwarning'] = 'This section of the test is in secure mode, this means that you need to take the cquiz in a secure window. Please turn off your popup blocker. Thank you.';
$string['popupnotice'] = 'Students will see this cquiz in a secure window';
$string['preprocesserror'] = 'Error occurred during pre-processing!';
$string['preview'] = 'Preview';
$string['previewquestion'] = 'Preview question';
$string['previewcquiz'] = 'Preview {$a}';
$string['previewcquiznow'] = 'Preview cquiz now';
...
$string['questioninuse'] = 'The question \'{$a->questionname}\' is currently being used in: <br />{$a->cquiznames}<br />The question will not be deleted from these cquizzes but only from the category list.';
...
$string['questionsinthiscquiz'] = 'Questions in this cquiz';
...
$string['cquiz:addinstance'] = 'Add a new cquiz';
$string['cquiz:attempt'] = 'Attempt cquizzes';
$string['cquizavailable'] = 'The cquiz is available until: {$a}';
$string['cquizclose'] = 'Close the cquiz';
$string['cquizclosed'] = 'This cquiz closed on {$a}';
$string['cquizcloses'] = 'cQuiz closes';
$string['cquizcloseson'] = 'This cquiz will close at {$a}';
$string['cquiz:deleteattempts'] = 'Delete cquiz attempts';
...
$string['cquiz:grade'] = 'Grade cquizzes manually';
$string['cquiz:ignoretimelimits'] = 'Ignores time limit on cquizzes';
$string['cquizisclosed'] = 'This cquiz is closed';
$string['cquizisopen'] = 'This cquiz is open';
$string['cquizisclosedwillopen'] = 'cQuiz closed (opens {$a})';
$string['cquizisopenwillclose'] = 'cQuiz open (closes {$a})';
$string['cquiz:manage'] = 'Manage cquizzes';
$string['cquiz:manageoverrides'] = 'Manage cquiz overrides';
$string['cquiznavigation'] = 'cQuiz navigation';
$string['cquizopen'] = 'Open the cquiz';
...
$string['cquizopened'] = 'This cquiz is open.';
$string['cquizopenedon'] = 'This cquiz opened at {$a}';
$string['cquizopens'] = 'cQuiz opens';
$string['cquizopenwillclose'] = 'This cquiz is open, will close on {$a} at';
$string['cquizordernotrandom'] = 'Order of cquiz not shuffled';
$string['cquizorderrandom'] = '* Order of cquiz is shuffled';
$string['cquiz:preview'] = 'Preview cquizzes';
$string['cquiz:regrade'] = 'Regrade cquiz attempts';
$string['cquiz:reviewmyattempts'] = 'Review your own attempts';
$string['cquizsettings'] = 'cQuiz settings';
$string['cquiz:view'] = 'View cquiz information';
$string['cquiz:viewreports'] = 'View cquiz reports';
$string['cquiztimer'] = 'cQuiz Timer';
$string['cquizwillopen'] = 'This cquiz will open {$a}';
...
$string['readytosend'] = 'You are about to send your whole cquiz to be graded.  Are you sure you want to continue?';
$string['reattemptcquiz'] = 'Do Next Review';
...
$string['regradenotallowed'] = 'You do not have permission to regrade this cquiz';
$string['regradingquestion'] = 'Regrading "{$a}".';
$string['regradingcquiz'] = 'Regrading cquiz "{$a}"';
$string['remove'] = 'Remove';
$string['removeallcquizattempts'] = 'Delete all cquiz attempts';
...
$string['reportusersall'] = 'all users who have attempted the cquiz';
$string['reportuserswith'] = 'enrolled users who have attempted the cquiz';
$string['reportuserswithorwithout'] = 'enrolled users who have, or have not, attempted the cquiz';
$string['reportuserswithout'] = 'enrolled users who have not attempted the cquiz';
$string['reportwhattoinclude'] = 'What to include in the report';
$string['requirepassword'] = 'Require password';
$string['requirepassword_help'] = 'If a password is specified, a student must enter it in order to attempt the cquiz.';
$string['requiresubnet'] = 'Require network address';
$string['requiresubnet_help'] = 'cQuiz access may be restricted to particular subnets on the LAN or Internet by specifying a comma-separated list of partial or full IP address numbers. This can be useful for an invigilated (proctored) cquiz, to ensure that only people in a certain location can access the cquiz.';
$string['response'] = 'Response';
$string['responses'] = 'Responses';
$string['results'] = 'Results';
$string['returnattempt'] = 'Return to attempt';
$string['reuseifpossible'] = 'reuse previously removed';
$string['reverttodefaults'] = 'Revert to cquiz defaults';
$string['review'] = 'Review';
$string['reviewafter'] = 'Allow review after cquiz is closed';
$string['reviewalways'] = 'Allow review at any time';
$string['reviewattempt'] = 'Review attempt';
$string['reviewbefore'] = 'Allow review while cquiz is open';
$string['reviewclosed'] = 'After the cquiz is closed';
...
$string['reviewopen'] = 'Later, while the cquiz is still open';
$string['reviewoptions'] = 'Students may review';
$string['reviewoptionsheading'] = 'Review options';
$string['reviewoptionsheading_help'] = 'These options control what information students can see when they review a cquiz attempt or look at the cquiz reports.
...
**Later, while the cquiz is still open** settings apply after this, and before the cquiz close date.

**After the cquiz is closed** settings apply after the cquiz close date has passed. If the cquiz does not have a close date, this state is never reached.';
...
$string['saveattemptfailed'] = 'Failed to save the current cquiz attempt.';
...
$string['savecquiz'] = 'Save this whole cquiz';
...
$string['showblocks'] = 'Show blocks during cquiz attempts';
$string['showblocks_help'] = 'If set to yes then normal blocks will be shown during cquiz attempts';
...
$string['shufflewithin_help'] = 'If enabled, the parts making up each question will be randomly shuffled each time a student attempts the cquiz, provided the option is also enabled in the question settings. This setting only applies to questions that have multiple parts, such as multiple choice or matching questions.';
...
$string['specificquestionnotoncquiz'] = 'Specified question is not on the specified cquiz';
...
$string['subneterror'] = 'Sorry, this cquiz has been locked so that it is only accessible from certain locations.  Currently your computer is not one of those allowed to use this cquiz.';
$string['subnetnotice'] = 'This cquiz has been locked so that it is only accessible from certain locations. Your computer is not on an allowed subnet. As teacher you are allowed to preview anyway.';
...
$string['timedelay'] = 'You are not allowed to do the cquiz since you have not passed the time delay before attempting another cquiz';
$string['timeleft'] = 'Time left';
$string['timelimit'] = 'Time limit';
$string['timelimit_help'] = 'If enabled, the time limit is stated on the initial cquiz page and a countdown timer is displayed in the cquiz navigation block.';
$string['timelimit_link'] = 'mod/cquiz/timing';
$string['timelimitexeeded'] = 'Sorry! cQuiz time limit exceeded!';
...
$string['updatesettings'] = 'Update cquiz settings';
...
$string['upgradesure'] = '<div>In particular the cquiz module will perform an extensive change of the cquiz tables and this upgrade has not yet been sufficiently tested. You are very strongly urged to backup your database tables before proceeding.</div>';
$string['upgradingcquizattempts'] = 'Upgrading cquiz attempts: cquiz {$a->done}/{$a->outof} (cQuiz id {$a->info})';
$string['upgradingveryoldcquizattempts'] = 'Upgrading very old cquiz attempts: {$a->done}/{$a->outof}';
$string['url'] = 'URL';
...
$string['usersnone'] = 'No students have access to this cquiz';
$string['validate'] = 'Validate';
$string['viewallanswers'] = 'View {$a} cquiz attempts';
...
$string['xhtml'] = 'XHTML';
$string['youneedtoenrol'] = 'You need to enrol in this course before you can attempt this cquiz';
$string['yourfinalgradeis'] = 'Your final grade for this cquiz is {$a}.';
