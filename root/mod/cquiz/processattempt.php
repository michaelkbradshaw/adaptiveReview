...
if ($attemptobj->is_finished()) {
    throw new moodle_cquiz_exception($attemptobj->get_cquizobj(),
...
if ($timeup) {
    if ($attemptobj->get_cquiz()->overduehandling == 'graceperiod') {
        if (is_null($graceperiodmin)) {
            $graceperiodmin = get_config('cquiz', 'graceperiodmin');
        }
        if ($timenow > $timeclose + $attemptobj->get_cquiz()->graceperiod + $graceperiodmin) {
...
add_to_log($attemptobj->get_courseid(), 'cquiz', 'close attempt',
