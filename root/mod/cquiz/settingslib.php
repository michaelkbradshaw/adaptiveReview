...
/**
 * Admin settings class for the cquiz review opitions.
 *
 * @copyright  2008 Tim Hunt
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_cquiz_admin_review_setting extends admin_setting {
    /**#@+
     * @var integer should match the constants defined in {@link mod_cquiz_display_options}.
    ...
    public function output_html($data, $query = '') {
        ...
        return format_admin_setting($this, $this->visiblename, $return,
                $this->description, true, '', get_string('everythingon', 'cquiz'), $query);
    }
}
