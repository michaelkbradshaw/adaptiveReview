...
class cquiz_access_manager {
    ...
    protected static function get_rule_classes() {
        return get_plugin_list_with_class('cquizaccess', '', 'rule.php');
    }
    ...
    public static function validate_settings_form_fields(array $errors,
            array $data, $files, mod_cquiz_mod_form $this) {
     ...
     *      which is the is of the cquiz being saved.
     */
    ...
    public function get_preflight_check_form(moodle_url $url, $attemptid) {
        return new mod_cquiz_preflight_check_form($url->out_omit_querystring(),
                array('rules' => $this->rules, 'cquizobj' => $this->cquizobj,
    ...
    public function make_review_link($attempt, $reviewoptions, $output) {
        ...
        if (!$reviewoptions->attempt) {
            ...
            return $output->review_link($this->cquizobj->review_url($attempt->id),
