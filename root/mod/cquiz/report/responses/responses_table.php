...
/**
 * This file defines the cquiz responses table.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class cquiz_responses_table extends cquiz_attempts_report_table {
     ...
     */
    public function __construct($cquiz, $context, $qmsubselect, cquiz_responses_options $options,
            $groupstudents, $students, $questions, $reporturl) {
        parent::__construct('mod-cquiz-report-responses-report', $cquiz, $context,
