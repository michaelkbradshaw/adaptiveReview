...
/**
 * Quiz statistics report, table for showing statistics of each question in the cquiz.
 *
...
class cquiz_statistics_table extends flexible_table {
    ...
    protected function col_actions($question) {
        return cquiz_question_action_icons($this->cquiz, $this->cmid, $question, $this->baseurl);
    }
    ...
    protected function col_name($question) {
        ...
        if ($url) {
            $name = html_writer::link($url, $name,
                    array('title' => get_string('detailedanalysis', 'cquiz_statistics')));
        }
    ...
    protected function col_intended_weight($question) {
        return cquiz_report_scale_summarks_as_percentage(
                $question->_stats->maxmark, $this->cquiz);
    }
        ...
        if ($question->_stats->negcovar) {
            ...
            if (!$this->is_downloading()) {
                $negcovar = html_writer::tag('div',
                        $negcovar . $OUTPUT->help_icon('negcovar', 'cquiz_statistics'),
