 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class cquiz_statistics_question_stats {
    public $questions;
     ...
     */
    public function load_step_data($cquizid, $currentgroup, $groupstudents, $allattempts) {
        global $DB;
        ...
        list($fromqa, $whereqa, $qaparams) = cquiz_statistics_attempts_sql(
                $cquizid, $currentgroup, $groupstudents, $allattempts, false);
        ...
        $this->lateststeps = $DB->get_records_sql("
                ...
                FROM $fromqa
                JOIN {question_attempts} qa ON qa.questionusageid = cquiza.uniqueid
                JOIN (
        ...
        foreach ($this->subquestions as $qid => $subquestion) {
            ...
            if ($subquestionstats[$qid]->differentweights) {
                ...
                echo $OUTPUT->notification(
                        ...
                        'cquiz_statistics', $this->subquestions[$qid]->name));
            }
