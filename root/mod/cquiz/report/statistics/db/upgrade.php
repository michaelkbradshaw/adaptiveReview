 ...
 */
function xmldb_cquiz_statistics_upgrade($oldversion) {
    global $DB;
    ...
    if ($oldversion < 2012061800) {
        ...
        // Changing type of field subqid on table cquiz_quest_response_stats to char.
        $table = new xmldb_table('cquiz_quest_response_stats');
        ...
        upgrade_plugin_savepoint(true, 2012061800, 'cquiz', 'statistics');
    }

    if ($oldversion < 2012061801) {

        // Changing type of field aid on table cquiz_quest_response_stats to char.
        $table = new xmldb_table('cquiz_quest_response_stats');
        ...
        // Statistics savepoint reached.
        upgrade_plugin_savepoint(true, 2012061801, 'cquiz', 'statistics');
    }
