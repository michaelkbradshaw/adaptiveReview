...
class cquiz_overview_options extends mod_cquiz_attempts_report_options {
    ...
    public function setup_from_user_preferences() {
        ...
        $this->slotmarks = get_user_preferences('cquiz_report_overview_detailedmarks', $this->slotmarks);
    }
    ...
    public function resolve_dependencies() {
        ...
        $this->checkboxcolumn = has_any_capability(
                array('mod/cquiz:regrade', 'mod/cquiz:deleteattempts'), context_module::instance($this->cm->id))
                && ($this->attempts != cquiz_attempts_report::ENROLLED_WITHOUT);
    }
}
