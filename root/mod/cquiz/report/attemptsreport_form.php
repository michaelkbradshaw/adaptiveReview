    ...
    protected function standard_attempt_fields(MoodleQuickForm $mform) {
        ...
        if (cquiz_report_can_filter_only_graded($this->_customdata['cquiz'])) {
            $gm = html_writer::tag('span',
                    cquiz_get_grading_option_name($this->_customdata['cquiz']->grademethod),
                    array('class' => 'highlight'));
            $mform->addElement('advcheckbox', 'onlygraded', get_string('reportshowonly', 'cquiz'),
                    get_string('optonlygradedattempts', 'cquiz_overview', $gm));
