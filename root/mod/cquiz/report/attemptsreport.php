...
abstract class cquiz_attempts_report extends cquiz_default_report {
    ...
    protected function init($mode, $formclass, $cquiz, $cm, $course) {
        ...
        $this->form = new $formclass($this->get_base_url(),
                array('qmsubselect' => $this->qmsubselect, 'cquiz' => $cquiz,
    ...
    protected function set_up_table_columns($table, $columns, $headers, $reporturl,
            mod_cquiz_attempts_report_options $options, $collapsible) {
    ...
    protected function delete_selected_attempts($cquiz, $cm, $attemptids, $allowed) {
        ...
        foreach ($attemptids as $attemptid) {
            ...
            add_to_log($cquiz->course, 'cquiz', 'delete attempt', 'report.php?id=' . $cm->id,
                    $attemptid, $cm->id);
